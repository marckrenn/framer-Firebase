...
The **Firebase module** allows your Framer prototype to **load**, **save** and **sync** data between multiple sessions and devices.
<br />
...
| Live @ [firebaseSlider](http://share.framerjs.com/21l0s8i8ygaj/) | Live @ [firebaseBubbles](http://share.framerjs.com/8b7yf4eu2z30/) |
...
I'd also like to recommend reading [*Supercharge your Framer prototype with Firebase, pt.1* (NOT UP YET)](link) on Medium.
...
|  ---  | Or start by using this [template file](http://share.framerjs.com/b13gkdacrmhg/)                                                                                |
...
| **7** | Save, load and sync data using the available [Class Methods](https://github.com/marckrenn/framer-Firebase#2-methods)                                           |
...
Please also refer to [Firebase's REST API reference](https://firebase.google.com/docs/reference/rest/database/) for additional information.
...
---
Updates data of specified *path*, without deleting omitted *sibling*-nodes.
...
---
Deletes the node and all *children* of the specified *path*.
...
#### • firebase.onChange(path, callback)
---
Fires when the Framer project is (re)loaded and whenever the value was changed, across multiple sessions and devices.
